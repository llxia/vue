        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="mb-4">
            <label
              for="type"
              :class="[
                form.type === 'Remote' || form.type === 'Internship'
                  ? 'text-red-700'
                  : 'text-green-700',
                'block',
                'font-bold',
          ...
          <h3 class="text-3xl mb-5">Company Info</h3>
          ...
          <div>
            <button
              class="bg-red-600 hover:bg-violet-600 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline"
              type="submit"
            >
              Add Job
            </button>
